...
Instance int31_serializable : Serializable int31.
Proof.
  refine
...
Instance zn2z_serializable {A} `{Serializable A} : Serializable (zn2z A).
Proof.
  refine
    {| serialize w1 :=
         serialize
...
Defined.
Instance word_serializable {A} `{Serializable A} (n : nat) : Serializable (word A n) :=
  (fix f (n : nat) :=
...
Instance BigNw1_serializable : Serializable BigN.w1 := ltac:(apply zn2z_serializable).
Instance BigNw2_serializable : Serializable BigN.w2 := ltac:(apply zn2z_serializable).
Instance BigNw3_serializable : Serializable BigN.w3 := ltac:(apply zn2z_serializable).
Instance BigNw4_serializable : Serializable BigN.w4 := ltac:(apply zn2z_serializable).
Instance BigNw5_serializable : Serializable BigN.w5 := ltac:(apply zn2z_serializable).
Instance BigNw6_serializable : Serializable BigN.w6 := ltac:(apply zn2z_serializable).
Instance BigN_serializable : Serializable bigN.
Proof.
  refine
    {| serialize n :=
         match n with
...
Defined.
Instance BigZ_serializable : Serializable bigZ :=
